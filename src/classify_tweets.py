...
def classify_tweets(tweets_df:pd.DataFrame,
                    trump_tweets:list, 
                    kamala_tweets:list, 
                    neutral_tweets:list)->pd.DataFrame:
...
if __name__ == "__main__":
    # loading up tweets dataset
    tweets_df = pd.read_csv("data/raw/subset.csv")
    tweets_df["Text"] = tweets_df["Text"].astype(str)
    
    # my labelled tweets dataset
    ...
    tweets_laballed_df = create_labelled_dataset(trump_tweet_list,harris_tweets_list,neutral_tweets)
    print(tweets_laballed_df.head())
    print(tweets_laballed_df['Label'].value_counts())
